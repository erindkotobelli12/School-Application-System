...
public class Student_Profile_Controller {
    ...
    // FXML Labels to be filled from Controller
    ...
    public void initialize() {
        Fullname.setText(s.getFirstName()+" "+ s.getLastName());
        Fullname1.setText(s.getFirstName()+" "+ s.getLastName());
        labelName.setText(s.getFirstName());
        labelSurname.setText(s.getLastName());
        labelId.setText(String.valueOf(s.getStudentId()));
        labelBirthday.setText(s.getDateOfBirth());
    ...
    private void handleBackButton(ActionEvent event) {
        try {
            ...
            System.err.println("Navigation error: Ensure student_view.fxml is in the correct resources folder.");
        }
    }
